	...
	<view class="content">
		<view class="trtc-demo-container">
		  <view class='title'  >
		    ...
		    <input type="number" :value="roomID" maxlength="20" data-key="roomID" @input='enterHandler' placeholder="请输入房间号" placeholder-style="color:#ffffff;opacity: 0.55;"/>
			</view>
			<view class="input-box">
		    <input type="text" :value="userID" maxlength="10" data-key="userID" @input='enterHandler' placeholder="请输入用户名(英文+数字)" placeholder-style="color:#ffffff;opacity: 0.55;"/>
		       ...
		       <!-- <view class="choice-content">
		        ...
		        <view class="choice-content">
		          <label class="label" for="switchLocalVideo">
		            <text>本地视频</text>
		            <switch id="switchLocalVideo" color="#006eff" checked="true" data-key="localVideo" bindchange="switchHandler"/>
		          </label>
		          <label class="label" for="switchLocalAudio">
		            <text>本地音频</text>
		            <view class="switch-right">
		              <switch id="switchLocalAudio" color="#006eff" checked="true" data-key="localAudio" bindchange="switchHandler"/>
		            </view>
		          </label>
		        </view>
		       <!-- <view class="choice-content">
		       ...
		       <!-- <view class="choice-content">
		        ...
		        <view class="choice-content">
		          ...
		          <radio-group class="radio-group-no-box" data-key="resolution" bindchange="selectHandler">
		            <label v-for="(item,index) in resolutionArray" :key="index" :class=" {radioItem:true,selected:resolution == item.value}">
		              <radio value="{{item.value}}" :checked="{{item.checked}}" /> {{item.title}}
		            </label>
		          </radio-group>
		        </view> -->
